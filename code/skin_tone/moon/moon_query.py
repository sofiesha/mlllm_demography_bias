"""
***************************************************************
*  3a. ALTERNATIVE Classification test for Moondream on skin tones
*  Script to classify skin tone in the MST-E dataset using Moondream
*  
*  This script processes the MST-E dataset by:
*  - Filtering out non-image files and ensuring valid image formats (.jpg, .jpeg, .png).
*  - Running the Moondream model to classify the skin tone of each image using the Monk Skin Tone (MST) scale.
...
RESULTS_CSV = Path("/Users/sofie/Library/CloudStorage/OneDrive-NTNU/NTNU/2. MIS/2. semester V25/Biometrics/github_repo/LLM_demography_bias_analysis/new_repo_sketch/results/moondream2/moon_less_strict.csv")
...
def sanitize_response(response: str) -> str:
    """
    Extract MSTX classification from Moondream response using regex.
    """
...
if __name__ == "__main__":
    try:
        ...
        logging.info("Make sure Ollama is running (`ollama serve`) and the Moondream model is downloaded.")
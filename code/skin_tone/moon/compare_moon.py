"""
***************************************************************
*  4b. Moondream2 skin tone continues: Merge with truth and Compare
*
*  This script evaluates the performance of moondreams's skin tone classification on the MST-E dataset by:
*  - Merging ground truth annotations with model predictions.
*  - Sanitizing and extracting predicted MST values from moondreams's responses.
...
*
*  This provides the performance overview of moondream on skin tone recognition using the MST scale.
***************************************************************
"""
...
results_df = pd.read_csv("/Users/sofie/Library/CloudStorage/OneDrive-NTNU/NTNU/2. MIS/2. semester V25/Biometrics/github_repo/LLM_demography_bias_analysis/new_repo_sketch/results/moondream2/moon_classification.csv")
...
# Step 8: Check distribution of predictions, especially MST1
mst1_predictions = merged_df_filtered[merged_df_filtered['prediction'] == 1]
print(f"Number of predictions for MST6: {mst1_predictions.shape[0]}")
...
plt.title('CONFUSION MATRIX (MOONDREAM - MST)')
plt.xlabel('Prediction')
plt.ylabel('Ground truth')
plt.show()

# Step 16: Save the merged and filtered dataframe to a new CSV for verification and record-keeping
merged_df_filtered.to_csv("/Users/sofie/Library/CloudStorage/OneDrive-NTNU/NTNU/2. MIS/2. semester V25/Biometrics/github_repo/LLM_demography_bias_analysis/new_repo_sketch/results/llava/merged_llava.csv", index=False)
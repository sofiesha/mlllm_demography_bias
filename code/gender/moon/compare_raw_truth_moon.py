...
*
*  This script evaluates the performance of moondreams gender classification by:
...
*
*  This provides a simple performance overview of moondream on gender recognition.
***************************************************************
"""
import pandas as pd
...
df = pd.read_csv("/Users/sofie/Library/CloudStorage/OneDrive-NTNU/NTNU/2. MIS/2. semester V25/Biometrics/github_repo/LLM_demography_bias_analysis/new_repo_sketch/results/gender/moon/gender_classification.csv") 
...
plt.title("CONFUSION MATRIX (MOONDREAM - GENDER)")
